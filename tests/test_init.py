...
async def test_setup_unload_and_reload_entry(hass, bypass_get_data):
    ...
    # them to be. Because we have patched the DenonAvr3805DataUpdateCoordinator.async_get_data
    # call, no code from custom_components/denon_avr_3805/api.py actually runs.
