"""Tests for Denon AVR-3805 api."""
import asyncio

import aiohttp
from custom_components.denon_avr_3805.api import (
    DenonAvr3805ApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = DenonAvr3805ApiClient("test", "test", async_get_clientsession(hass))
